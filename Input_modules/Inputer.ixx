...
export namespace input_tools {
        ...
        public:
            ...
            Input_reader(Input_stream_handler_ptr a, const absolute_base::Base_printer& b, const absolute_base::All_non_terminal_entries<estd::regex_pattern>& c, std::shared_ptr<bool> d, std::shared_ptr<char> e) :input_stream{ a }, output_manager{ b }, all_config{ c }, multithreaded{ d }, delimeter{e} {}
        ...
        private:
            ...
            absolute_base::All_non_terminal_entries<estd::regex_pattern>&  all_config;

...
export namespace printing_tools {
    ...
    namespace helper_templates_for_options {
        ...
        inline Non_terminal_name_entry* return_non_terminal_entry<false>(const std::string& output_config, std::string::size_type* position, absolute_base::All_non_terminal_entries* list_of_entries_to_find_it_in) {
            return *(All_non_terminal_entries->begin());
        }
    ...
    private:
        ...
        void read_single_entry_and_push_it_as_the_sub_entry_an_the_entry_passed(absolute_Base::Non_terminal_name_entry* entry) {
            ...
            config_parsing_tools::Config_reader_helper::parse_raw_input(all_config_for_output.get(), std::stringstream{ std::move(input_line) });
            push_latest_entry_as_sub_entry_of_an_entry(list_of_entries_to_push_it_in, entry);
        ...
        template<bool search>
        void remove_entry(absolute_base::All_non_terminal_entries* list_of_entries_to_find_it_in) {
            absolute_base::Non_terminal_name_entry* non_term_entry = return_non_terminal_entry<search, list_of_entries_to_find_it_in>;
            list_of_entries_to_find_it_in.remove_entry(non_term_entry);
        }
        template<bool search>
        void add_entry(absolute_base::All_non_terminal_entries* list_of_entries_to_find_it_in) {

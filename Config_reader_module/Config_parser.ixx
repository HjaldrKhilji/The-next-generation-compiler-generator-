...
export   namespace config_parsing_tools {
    ...
    protected:
        ...
        virtual void escape_backslash_capital_n(std::stringstream* line_stream,std::string* input_string, size_t* where_is_it_found) {
        ...
        virtual void escape_backslash_capital_a_by_reading_nested_symbols(std::stringstream* line_stream, absolute_base::All_non_terminal_entries* all_entries,std::string* input_string, size_t* where_is_it_found) {
            // Precondition 1: The input stream named line_stream is in a valid state for reading.
        ...
        virtual void escape_backslash_capital_u_by_reading_nested_symbols(std::stringstream* line_stream, absolute_base::All_non_terminal_entries* all_entries,std::string* input_string, size_t* where_is_it_found) {
            // Precondition 1: The input stream named line_stream is in a valid state for reading.
              // Precondition 2: The non-terminal entry name read from the stream
                  // must correspond to an entry that already exists in the global non-terminal
           // entry table.
        ...
        virtual std::string return_raw_config_for_pattern(std::stringstream* line_stream) {
        ...
        virtual std::string take_space_terminated_input_and_escape_it(std::stringstream* line_stream, absolute_base::All_non_terminal_entries* all_entries) {
            // Precondition:
            ...
            *line_stream >> std::skipws >> semantic_pattern_to_check;
            absolute_base::escape_string(
                &semantic_pattern_to_check, {
                  ...
                  [this,line_stream,all_entries](std::string& input_string, size_t& where_found) {
                    this->escape_backslash_capital_n(line_stream, &input_string, &where_found);
                  },
                  [this,line_stream, all_entries](std::string& input_string, size_t& where_found) {
                    this->escape_backslash_capital_u_by_reading_nested_symbols(line_stream, all_entries,&input_string, &where_found);
                  }
                //size of ) is one hence I wrote 1 in the second argument
                });
        ...
        virtual void parse_config_for_semantic_entry(std::stringstream* line_stream,absolute_base::Settings_for_semantical_rules* settings_for_current_config, unsigned int* minimum_amount_of_Matches, unsigned int* maximum_amount_of_matches) {
        ...
        virtual void semantical_analyzer_entry_reader(std::stringstream* line_stream, absolute_base::All_non_terminal_entries* all_entries) {
        ...
        virtual std::string get_raw_input(std::istream* input_stream) {
        ...
        virtual void parse_raw_input(absolute_base::All_non_terminal_entries* all_entries, std::stringstream *line_stream) {
            ...
            *line_stream >> std::skipws >> non_terminal_pattern;
            ...
            absolute_base::escape_string(
                &non_terminal_pattern, {
                  ...
                  [this, line_stream, all_entries](std::string& input_string, size_t& where_found) {
                    this->escape_backslash_capital_a_by_reading_nested_symbols(line_stream, all_entries,&input_string, &where_found);
                  }
        ...
        class Config_reader : private Config_reader_helper {
        ...
        private:
            ...
            void change_current_line() {
                ...
                parse_raw_input(&line_stream, &all_entries);
